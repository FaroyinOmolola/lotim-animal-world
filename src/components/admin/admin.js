...
function Admin() {
  ...
  return (
    <div id="admin-nav" className="mt-5">
     <Router>
      <Nav defaultActiveKey="/" className=" text-primary text-md-center fixed-top ">
        <LinkContainer to={`${url}/enquiries`}> 
          <Nav.Link className="nav-link" eventKey="link-1">Enquiries</Nav.Link>
        </LinkContainer>
        <LinkContainer to={`${url}/orders`}> 
          <Nav.Link className="nav-link" eventKey="link-2">Orders</Nav.Link>
        </LinkContainer>
        <LinkContainer to={`${url}/products`}> 
          <Nav.Link className="nav-link" eventKey="link-3">Products</Nav.Link>
        </LinkContainer>
